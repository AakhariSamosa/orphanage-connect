...
import { Heart, MessageCircle, Share2, MoreVertical, Send, Image as ImageIcon, Video, Loader2 } from 'lucide-react';
    ...
    <Card className="overflow-hidden">
      <CardHeader className="flex flex-row items-center gap-4 p-4">
        ...
        <div className="flex-1">
          <h3 className="font-semibold">Shri Shradhanand Anathalay</h3>
      ...
      <CardContent className="p-0">
        {post.content && (
          <p className="px-4 pb-4 text-foreground">{post.content}</p>
        )}
      ...
      <CardFooter className="flex flex-col p-0">
        ...
        <div className="flex items-center justify-around w-full border-t py-1">
          ...
          >
            <Heart className={`w-5 h-5 mr-2 ${isLiked ? 'fill-primary' : ''}`} />
            Like
          </Button>
          <Button
            variant="ghost"
